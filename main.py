...
if __name__ == "__main__":
    ...
    gen_image.gen_image(
        pretrained_model_name_or_path=args.pretrained_model_name_or_path,
        output_img_path_name=args.output_image_path + "/__out__" + src_file_name + "_" + ref_file_name + "_" + str(args.guidance_scale_train_ref) + "_" + str(args.guidance_scale_train_src) + "_" + str(args.guidance_scale_gen) + time_smp + ".png",
        backward_prompts=["", "<s2>"],
        model_id=args.output_dir,
        train_step=args.max_train_steps,
