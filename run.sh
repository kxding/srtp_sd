cuda_device="0"
image_dir1="12-7-1"
image_dir2="12-7-1-cfg"
image_dir3="12-7-1-cfg+D"
image_dir4="pika"
image_dir5="rabbit"
cross_attn=0.2
self_attn=0.9
 ...
 CUDA_VISIBLE_DEVICES=${cuda_device} accelerate launch main.py \
                     ...
                     --only_save_embeds \
                     --src_embedding_path="./output/${image_dir4}" \
                     --use_prev_embeddings \
...
CUDA_VISIBLE_DEVICES=${cuda_device} accelerate launch main.py \
 ...
 CUDA_VISIBLE_DEVICES=${cuda_device} accelerate launch main.py \
                     --concept_image_dir="./examples/lion/" \
                     --content_image_dir="./examples/rabbit/"  \
                     --initializer_token="pokemon" \
                     --pretrained_model_name_or_path="/data1/chenxuan/model" \
                     --output_dir="./output/${image_dir5}" \
                     --output_image_path="./output_images/${image_dir5}" \
                     --cross_attention_injection_ratio=${cross_attn} \
                     --self_attention_injection_ratio=${self_attn}  \
                     --guidance_scale_train_src=7.5 \
                     --guidance_scale_train_ref=7.5 \
                     --guidance_scale_gen=7.5 \
                     --only_save_embeds \
                     --src_embedding_path="./output/${image_dir5}" \
                     --use_prev_embeddings \
                     --use_l1 --max_train_steps=100 --no_controller
...
CUDA_VISIBLE_DEVICES=${cuda_device} accelerate launch main.py \
 ...
 CUDA_VISIBLE_DEVICES=${cuda_device} accelerate launch main.py \
                     ...
                     --src_embedding_path="./output/${image_dir4}" \
                     --use_prev_embeddings \
                     --use_l1 --max_train_steps=100 --no_controller --use_direct_inversion
 CUDA_VISIBLE_DEVICES=${cuda_device} accelerate launch main.py \
                     --concept_image_dir="./examples/lion/" \
                     --content_image_dir="./examples/jieni/"  \
                     --initializer_token="pokemon" \
                     ...
                     --src_embedding_path="./output/${image_dir4}" \
                     --use_prev_embeddings \
                     --use_l1 --max_train_steps=100 --use_direct_inversion
CUDA_VISIBLE_DEVICES=${cuda_device} accelerate launch main.py \
                     --concept_image_dir="./examples/lion/" \
                     --content_image_dir="./examples/jieni/"  \
                     --initializer_token="pokemon" \
...
#                     --guidance_scale_gen=7.5 \
#                     --only_save_embeds \
#                     --use_l1 --max_train_steps=100 --use_ref_cfg --no_controller
...
# #                     --guidance_scale_gen=7.5 \
# #                     --only_save_embeds \
# #                     --use_l1 --max_train_steps=100 --use_ref_cfg --no_controller --use_direct_inversion
# #
# #
# # CUDA_VISIBLE_DEVICES=${cuda_device} accelerate launch main.py \
# #                     --concept_image_dir="./examples/che/" \
